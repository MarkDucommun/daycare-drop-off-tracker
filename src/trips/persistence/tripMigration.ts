import {InTransaction} from "../../utilities/databaseAccess";
import {flatMapAsync, map, Result} from "../../utilities/results";

// TODO probably insert some logs?
export const ensureTablesExist: InTransaction<null> = (execute, _, logger): Promise<Result<string, null>> => execute("PRAGMA foreign_keys = ON;")

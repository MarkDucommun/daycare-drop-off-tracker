...
export type Transaction = <T>(fn: InTransaction<T>, logger?: Logger) => Promise<Result<string, T>>
...
export const createTransactionCreator = (database: SQLite.SQLiteDatabase, logger: Logger = databaseAccessLogger): Transaction => {
